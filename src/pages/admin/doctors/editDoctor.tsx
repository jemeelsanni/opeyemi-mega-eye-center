...
import { FaSpinner, FaTimes, FaUpload, FaTrash } from 'react-icons/fa';
...
const EditDoctor: React.FC<EditDoctorProps> = ({ doctor,
    ...
    const [imagePreview, setImagePreview] = useState<string | null>(doctor.image || null);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await apiClient.put(`/doctors/admin/${doctor._id}`, submitFormData, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                }
            });

            // Add null checks before calling the functions
                ...
                >
                    ...
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-4">
                                <label htmlFor="password-edit" className="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <div className="mb-4">
                                <label htmlFor="speciality-edit" className="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <div className="mb-4">
                                <label htmlFor="phoneNumber-edit" className="block text-sm font-medium text-gray-700 mb-1">
                                    Phone Number
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-4">
                                <label htmlFor="bio-edit" className="block text-sm font-medium text-gray-700 mb-1">
                                    Bio
                                </label>
                                <textarea
                                    id="bio-edit"
                            ...
                            <div className="mb-4">
                                <div className="flex items-center">
                                    ...
                                    />
                                    <label htmlFor="isActive-edit" className="ml-2 block text-sm text-gray-700">
                                        Active
                                    </label>
                                </div>
                            </div>
