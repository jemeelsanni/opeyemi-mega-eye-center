// pages/admin/blogs/editBlog.tsx
...
const EditBlog: React.FC = () => {
    useAuth(); // Keep the auth context without destructuring
    ...
    useEffect(() => {
        const fetchBlog = async () => {
            if (!id) return;
            const response = await blogApi.getAdminBlog(id) as ApiResponse;
            ...
            try {
                ...
                const blog: BlogResponse = response.data.data;
                setTitle(blog.title);
                ...
                setErrorMessage("Failed to load blog. Please try again or contact support.");
            } finally {
                setLoading(false);
            }
        };
            ...
            <AdminLayout>
                <div className="container mx-auto px-4 py-8">
                    <div className="flex justify-center py-12">
                        <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#F08C5A]"></div>
        ...
        <AdminLayout>
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    {successMessage && (
                        <div className="mb-6 p-4 rounded shadow-sm bg-green-100 border-l-4 border-green-500 text-green-700">
                            {successMessage}
                        </div>
                    )}

                    {errorMessage && (
                        <div className="mb-6 p-4 rounded shadow-sm bg-red-100 border-l-4 border-red-500 text-red-700">
                            {errorMessage}
                        </div>
                    )}
