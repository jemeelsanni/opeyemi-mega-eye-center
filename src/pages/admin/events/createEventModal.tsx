...
const CreateEventModal: React.FC<CreateEventModalProps> = ({ onClose, onEventCreated }) => {
    ...
    // Fix for handleSubmit in CreateEventModal
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await apiClient.post('/events/admin', formDataToSubmit, {
                headers: {
                            ...
                            <div className="border-t border-gray-200 pt-4 mt-4">
                                ...
                                <div className="bg-blue-50 p-4 rounded-lg mb-4">
                                    <p className="text-sm text-blue-600">
                                        Upload multiple images to create a gallery for this event. You'll be able to rearrange, add captions, or delete images after creating the event.
                                    </p>
                                </div>
