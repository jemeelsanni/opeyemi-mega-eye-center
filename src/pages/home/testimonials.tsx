  ...
  return (
    <div>
      <div className="hero-large-screen">
        <div className="mt-32">
          <section className=" bg-zinc-100 px-[100px] py-[100px]">
            <div className="text-center">
              <h1 className=" text-3xl font-semibold">Testimonials</h1>
              <p className="text-xl mt-4">
                Over the years, we've treated patients, who can testify on how
                quality our treatment is.
              </p>
            </div>
            <div className=" mt-12 grid grid-cols-3 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
      ...
      <div className="hero-small-screen">
        <div className="mt-8">
          <section className=" bg-zinc-100 px-6 py-6">
            <div className="text-center">
